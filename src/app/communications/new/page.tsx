    ...
    <main className="mx-auto max-w-2xl p-8">
      ...
      <Card className="mt-4">
        <CardHeader>
          ...
          <CardDescription>
            Faits durs (jamais inventés par l&apos;IA) et matière libre.
            Génère 4 posts en chaîne : J-30, J-15, J-5, J-1.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <fieldset className="flex flex-col gap-4" disabled={loading}>
              <div className="flex flex-col gap-2">
                ...
                <Input id="name" name="name" required placeholder="Talk 4 — Design systems" />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input id="event_location" name="event_location" placeholder="La Commune, Lyon" />
              </div>

              <div className="flex flex-col gap-2">
                <Label htmlFor="event_link">Lien d&apos;inscription</Label>
                <Input id="event_link" name="event_link" type="url" placeholder="https://..." />
              </div>

              <div className="flex flex-col gap-2">
                <Label htmlFor="intervenants_text">Intervenants (matière libre)</Label>
                <Textarea
            ...
            <Button type="submit" disabled={loading}>
              {loading ? "Génération en cours…" : "Générer 4 posts"}
            </Button>
          </form>
        </CardContent>
      </Card>
